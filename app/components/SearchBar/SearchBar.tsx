...
const SearchBar = ({ handleScrollToSearch }) => {
  ...
  return(
    <div className="flex flex-col items-center relative text-white">
      ...
      <div className="relative w-full md:w-2/4 flex items-center z-50">
        <input onClick={handleScrollToSearch} className="w-full px-11 py-2 text-lg bg-[#233349] placeholder-slate-500 rounded-full border-2 border-slate-400 focus-visible:border-white outline-none" placeholder="Search by name or number (Coming soon!)" />
